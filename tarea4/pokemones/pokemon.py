...
#Charmander es de tipo fuego, Bulbasaur es de tipo planta, Squirtle es de tipo agua y Pikachu de tipo eléctrico. 
...
class Pokemon():
    ...
    def atacarMordisco(self):
        print(f"Soy {self.nombrePokemon} y estoy atacando con Mordisco")